...
export class Game {
  ...
  createEnemies() {
    ...
    if (this.currentLevel === 1) {
      enemies.push(new Enemy(220, 430, 130))
      enemies.push(new Enemy(220, 230, 130))
    } else if (this.currentLevel === 2) {
      enemies.push(new Enemy(170, 430, 100))
      enemies.push(new Enemy(370, 360, 100))
      enemies.push(new Enemy(320, 220, 100))
    } else {
      enemies.push(new Enemy(120, 460, 80))
      enemies.push(new Enemy(300, 400, 80))
      enemies.push(new Enemy(480, 340, 80))
      enemies.push(new Enemy(520, 220, 80))
    }
